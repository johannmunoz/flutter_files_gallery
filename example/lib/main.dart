...
class _MyHomePageState extends State<MyHomePage> {
  final List<FileItem> urls = [
    FileItem(
      ...
      value: ValueItem(
          name:
              'test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-test-image-.png'),
    ),
    FileItem(
