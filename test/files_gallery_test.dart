...
void main() {
  ...
  test('adds one to input values', () async {
    ...
    var urlItem = GalleryUrl(
      filename: 'scaled_ab6c645c-2c3a-4738-9e69-a532d1fd5eac1409733124.jpg',
      url:
    ...
    var fileItem = await ThumbnailsManager().getNetworkThumbnail(urlItem);
    print(watch.elapsedMilliseconds);
    watch.stop();
  });
}
